...
PATH_COMPANY_CODE = "./data/dataset_input/etf_list.txt" #(회사명 주식코드)로 이루어진 파일
PATH_CLOSING_PRICE_OF_1YEAR = "./data/dataset_input/etf_cp_list.txt" #(584개의 회사에 대한 1년 개장일 248일 종가)로 이루어진 파일
